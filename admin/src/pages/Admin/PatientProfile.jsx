...
const PatientProfile = () => {
  ...
  const { aToken, patientData, getPatientProfile, patientAppointments, getPatientAppointments, patientPrescriptions, getPatientPrescriptions, downloadPrescriptionPDF } = useContext(AdminContext);
