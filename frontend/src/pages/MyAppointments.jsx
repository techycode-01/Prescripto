            ...
            <div className="flex flex-col gap-2 justify-end">
              ...
              {!item.cancelled && !item.isCompleted && (
                <button
                  ...
                  className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border border-gray-200 hover:bg-red-600 hover:text-white cursor-pointer transition-all duration-300 "
                >
                  Cancel appointment
                </button>
              )}
